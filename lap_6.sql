...
as
	...
	begin
		print N'L??ng t?i thi?u ph?i t? 15000'
		...
		VALUES
		(N'Hu?nh',N'T?n',N'??t','2','10-9-1999','an giang','Nam',20000,'005',1);
...
update NHANVIEN set TENNV = N'??T' where MANV ='005'
...
INSERT INTO [dbo].[NHANVIEN]([HONV],[TENLOT],[TENNV],[MANV],[NGSINH],[DCHI],[PHAI],[LUONG],[MA_NQL],[PHG])
     VALUES (N'HU?NH',N'T?N ',N'??T','123','10-12-1999','HCM','Nam',200000,'005',1)
GO
-----6.2.2---
